...
if(isset($_POST['edit'])){
    ...
    $minInventory = (int)$_POST['minInventory'];
    $maxInventory = (int)$_POST['maxInventory'];

    $image_1 = (int)$_POST['image_id_1'];
    $image_2 = (int)$_POST['image_id_2'];
    $image_3 = (int)$_POST['image_id_3'];
    ...
    if(empty($errors)){
        $slug = Basics::slugify($product_id.'-'.$title);
        // IT'S EMPTY
        Alert::setAlert('success', array("Your products is now created!"));
        $Products->edit($product_id, $user_id, $slug, $title, $category, $inventory, $minInventory, $maxInventory, $image_1, $image_2, $image_3, $culturing, $dirttype, $price, $description, $status);
...
$image_1 = $Gallery->getImage($product->image_1);
$image_2 = $Gallery->getImage($product->image_2);
$image_3 = $Gallery->getImage($product->image_3);
?>
<div class="content">
    <div class="header">
        <h1>Edit Product</h1>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    <input id="form-title" value="<?php echo $product->name;?>" class="form-control" name="title" type="text">
                </div>
                <div class="form-group">
                    <label for="form-status">Status *</label>
                    <select id="form-status" class="form-control" name="status">
                        <option value="0">Public</option>
                        <option <?php if($product->status==1){ echo "selected"; } ?> value="1">Draft</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input id="form-title" value="<?php echo $product->inventory;?>" class="form-control" name="inventory" type="number">
                </div>
                <div class="form-group">
                    <label for="form-title">Min Inventory</label>
                    <input id="form-title" class="form-control" value="<?php echo $product->min_inventory;?>" name="minInventory" type="number">
                </div>
                <div class="form-group">
                    <label for="form-title">Max Inventory</label>
                    <input id="form-title" class="form-control" value="<?php echo $product->max_inventory;?>" name="maxInventory" type="number">
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    <input type="number" name="image_id_1" class="form-control" id="image-1-id" value="<?php echo $image_1->id; ?>" style="display:none;">
                    <input type="text" class="form-control" id="image-1-name" disabled value="<?php echo $image_1->name; ?>">
                </div>
                <div class="form-group">
                    <label for="form-category">Image 2 - <a href="#" data-toggle="modal" data-target="#image-2">Choose Thumbnail</a></label>
                    <input type="number" name="image_id_2" class="form-control" id="image-2-id" value="<?php echo $image_2->id; ?>" style="display:none;">
                    <input type="text" class="form-control" id="image-2-name" disabled value="<?php echo $image_2->name; ?>">
                </div>
                <div class="form-group">
                    <label for="form-category">Image 3 - <a href="#" data-toggle="modal" data-target="#image-3">Choose Thumbnail</a></label>
                    <input type="number" name="image_id_3" class="form-control" id="image-3-id" value="<?php echo $image_3->id; ?>" style="display:none;">
                    <input type="text" class="form-control" id="image-3-name" disabled value="<?php echo $image_3->name; ?>">
                </div>
                <div class="form-group">
                    <label for="form-title">Culturing *</label>
                    <input id="form-title" class="form-control" value="<?php echo $product->culturing;?>" name="culturing" type="text">
                </div>
                <div class="form-group">
                    ...
                    <select id="form-status" class="form-control" name="dirttype">
                        ...
                        foreach ($Products->getdirt() as $dirt) {
                            $selected="";
                            if($product->dirt_id==$dirt->id){
                                $selected="selected";
                            }
                            echo "<option $selected value=\"{$dirt->id}\">{$dirt->name}</option>\n";
                        }
                        ?>
                    </select>
                </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="form-group">
                    ...
                    <textarea id="form-description" class="ckeditor" name="description" class="form-control" rows="22" style="resize:none;"><?php echo $product->description;?></textarea>
                </div>
            </div>
        </div>
        <div class="row">
